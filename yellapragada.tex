...
\includesvg[width=\columnwidth]{setupphoto.svg}
\end{center}
...
\begin{figure}
\begin{center}
\includesvg[width=\columnwidth]{scissor_jack.svg}
\end{center}
\caption{The scissor jack was used to apply a controlled force and the digital scale recorded the normal force at various...}
\label{fig:setup-epe}
\end{figure}
...
\begin{figure}
\begin{center}
\includesvg[width=\columnwidth]{force_graph.svg}
\end{center}
\caption{Force versus compression graph used to calculate total elastic potential energy via area under the curve.}
\label{fig:force_graph}
\end{figure}

The force compression graph is seen in \cref{fig:force_graph}. Total elastic potential energy was calcualated by integrating the area under the curve in...
