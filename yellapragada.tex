...
\end{figure}
The force-compression graph is seen in \cref{fig:force_graph}. Total ($EPE$) was calculated by integrating the area under the curve in three segments, giving \qty{0.294}{\joule}.
