...
\label{tab:happy} 
\begin{ruledtabular}
\begin{tabular}{cS[table-format=1.4]S[table-format=1.2]S[table-format=3.1]SSS} 
...
\label{tab:sad} 
\begin{ruledtabular}
\begin{tabular}{cS[table-format=1.4]S[table-format=1.2]S[table-format=2.1]SSS} 
trial & {$m$, \unit{\kilo\gram}} & {$h$, \unit{\meter}} & {$v_{\text{launch}}$, \unit{\meter\per\second}} & {$KE$, \unit{\milli\joule}} & {$GPE$, \unit{\milli\joule}} & {KE - GPE, \unit{\milli\joule}} \\
\colrule \\
